                        ...
                        <div class="collapse navbar-collapse " id="bs-example-navbar-collapse-1">
                            <nav class="menu--iris">
                                <ul class="nav navbar-nav menu__list ">
                                    ...
                                    <li ><a href="<?php echo url_for("/staff/pages/Themes.php?lang=" . $_GET['lang']); ?>" class=" bordre"><i class="fa fa-tasks"></i> <?= $themes_title;?></a></li>
                                    ...
                                    <li ><a href="<?php echo url_for("/staff/pages/Programme.php?lang=" . $_GET['lang']); ?>" class=" bordre"><i class="fa fa-list"></i> <?= $programme_title;?></a></li>
                                    <!--<li ><a href="<?php // echo url_for("/staff/pages/Inscription.php?lang=" . $_GET['lang']); ?>" class=" bordre"><i class="fa fa-file"></i> Inscription</a></li>-->
                                    ...
                                    <!--<li ><a href="<?php // echo url_for("/staff/pages/FraisInscription.php?lang=" . $_GET['lang']); ?>" class=" bordre"><i class="fa fa-euro"></i> Frais</a></li>-->

                                    <li ><a href="<?php echo url_for("/staff/pages/commite.php?lang=" . $_GET['lang']); ?>" class=" bordre"><i class="fa fa-group"></i> <?= $comite_menu_title;?></a></li>
